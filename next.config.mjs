...
const nextConfig = {
  ...
  images: {
    // Contractor logos and portfolio photos live in Supabase Storage, not
    // /public -- next/image needs this explicit allowlist before it will
    // optimize (resize/compress/serve modern formats for) an external URL.
    remotePatterns: [
      {
        protocol: "https",
        hostname: "dmyuuqrdycgzvnduzmqx.supabase.co",
